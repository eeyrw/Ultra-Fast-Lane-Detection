...
def testNet(net, args, cfg, testWithAux, lastMetrics=None):
    ...
    return eval_lane(net, cfg.DATASET.NAME, cfg.DATASET.ROOT, cfg.TEST.WORK_DIR, cfg.NETWORK.GRIDING_NUM, testWithAux, cfg.NETWORK.USE_MID_AUX, distributed, lastMetrics=lastMetrics, batch_size=cfg.TEST.BATCH_SIZE, proportion=cfg.DATASET.TEST_PROPORTION)
