...
_C.DATASET.EXTRA_SPLIT_LIST = None


_C.SEMI_SPVSR = CN()
_C.SEMI_SPVSR.INCLUE_STEPS = [0, 1, 2, 3, 4]
_C.SEMI_SPVSR.ITER_NUM = 20
_C.SEMI_SPVSR.STEP4_SCHEME = 'exchange'
...
_C.NETWORK.USE_MID_AUX = False
_C.NETWORK.USE_SPP = False
_C.NETWORK.USE_ATTN = False
_C.NETWORK.USE_RESA = False
_C.NETWORK.USE_SFL_ATTN = False

# LOSS
_C.LOSS = CN()
_C.LOSS.DISTILL_LOSS_TYPE = 'mse'
