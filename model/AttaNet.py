...
class AttaNetHeadMod(nn.Module):
    def __init__(self, *args, **kwargs):
        super(AttaNetHeadMod, self).__init__()
        self.resnet = resnet(layers = 'res18')
    ...
    def forward(self, x):
        raw_feat8, raw_feat16, raw_feat32 = self.resnet(x)
        h8, w8 = raw_feat8.size()[2:]
        h16, w16 = raw_feat16.size()[2:]

        # Attention Fusion Module
        feat16 = self.conv_head16(raw_feat16)
        atten = self.afm(feat16, raw_feat32)
        feat32 = self.conv_head32(raw_feat32)
        ...
        feat16_up = self.sam(feat16_sum)

        return raw_feat8, feat16_up, feat32
...
class AttaNetHead(nn.Module):
    ...
    def forward(self, x):
        ...
        return feat16_up, feat32_up, raw_feat8, raw_feat16, raw_feat32
