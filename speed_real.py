...
if __name__ == "__main__":
    ...
    net = parsingNet(pretrained = False, backbone='res18',cls_dim = (100+1,56,4),use_aux=False).cuda()
    # net = parsingNet(pretrained = False, backbone='res18',cls_dim = (200+1,res18,4),use_aux=False).cuda()
    net.eval()
